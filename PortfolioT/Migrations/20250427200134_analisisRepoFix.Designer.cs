...
namespace PortfolioT.Migrations
{
    ...
    [Migration("20250427200134_analisisRepoFix")]
    partial class analisisRepoFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioT.DataBase.Models.DifferenceRepo.AnalisisUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AnalisisUser");
                });

            modelBuilder.Entity("PortfolioT.DataBase.Models.DifferenceRepo.AnalisysRepo", b =>
                {
                    b.Property<long>("userId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("userId", "serviceId", "title");
            ...
            modelBuilder.Entity("PortfolioT.DataBase.Models.DifferenceRepo.AnalisysRepo", b =>
                {
                    ...
                    b.HasOne("PortfolioT.DataBase.Models.DifferenceRepo.AnalisisUser", "user")
                        .WithMany()
                        .HasForeignKey("userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
